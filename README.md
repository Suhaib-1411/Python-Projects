...
All tasks and projects completed during my **Python Internship**. 

This repository contains 9 practical Python projects that demonstrate my skills in automation, data handling, CLI development, security, and more.
...
- **Security**: hashlib, custom encryption
- **Automation**: smtplib, OS, Shutil
- **Reporting**: ReportLab
- **Web**: BeautifulSoup, Requests (Task 9)
- **CLI**: Rich formatting & menu systems
...
Python-Internship-Projects/
├── README.md
├── Task-01-Advanced-CLI-Contact-Management/
├── Task-02-Multi-User-Authentication/
├── Task-03-Custom-Encryption-Tool/
├── Task-04-System-Log-Analyzer/
├── Task-05-Bulk-Email-Sender/
├── Task-06-PDF-Report-Generator/
